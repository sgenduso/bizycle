...
findMessagePosters: function (messages) {
  var msgPromises = messages.map(function (message) {
    return module.exports.findUserById(message.userId)
    .then(function (user) {
      message.dateParsed = module.exports.dateParse(message.datePosted);
      message.postedBy = module.exports.firstNameLastInitial(user.firstName, user.lastName);
    });
  });
